...
LibreOffice는 무료 오픈소스 오피스 소프트웨어이다. 기본적으로 MS 오피스에서 보던 것처럼 스프레드시트,프레젠테이션,문서 작업등을 할 수 있는 환경을 갖추고 있다. 오픈소스이나 MS 오피스와의 호환성을 상당히 신경써서 docx xlsx pptx 포맷을 열 수 있고, 또 저장도 할 수 있다. 또한 추가기능을 설치할 수 있고, Java기반으로 호환성이 높다. 그러나 사용자가 적은 편이라 문제 발생시 도움을 구하기가 어렵다는 단점은 존재한다.ㄴ
