...
<img width="200" height="200" src="./img/edge.png">
...
<img width="180" height="180" src="./img/android.png">

[소스코드 다운로드 링크](https://source.android.com/)

for offline - https://source.android.com/

Android는 Linux커널을 기반으로 제작한 운영체제이다. 라이선스는 GPL과 아파치를 적용하고 있다. 현재 안드로이드는 세계에서 가장 많은 사용자를 보유한 운영체제이며, 가장 대표적인 오픈소스 소프트웨어이다. 커널은 C로 제작되어 있고, 몇몇 라이브러리는 C++로, UI와 응용 소프트웨어는 Java로 구성되어 있다. 현재 안드로이드는 커널부터 SDK(소프트웨어 개발 툴) 까지 전부 무료로 나와있다.
